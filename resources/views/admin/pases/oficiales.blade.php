...
<div class="max-w-7xl mx-auto">
  ...
  <div class="flex items-center justify-between mb-4">
    <h1 class="text-xl font-bold text-gray-900 dark:text-white">Módulo Oficiales - Generar Pase</h1>
    <div class="flex gap-2">
      <a href="{{ route('pases.oficiales.descargar') }}"
  ...
  <form action="{{ route('pases.oficiales.generar') }}" method="POST" enctype="multipart/form-data"
        class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mb-6">
    @csrf

    <div class="grid md:grid-cols-2 gap-4">
      <div>
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Excel Personal (ORD, CEDULA, APELLIDO_1, APELLIDO_2, NOMBRE_1, NOMBRE_2)</label>
      ...
      <div>
        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Excel Vacantes (nomenclatura_base, funcion_efectiva, diferencia, estado)</label>
    ...
    <div class="relative overflow-x-auto">
      <table class="w-full text-sm text-left text-gray-700 dark:text-gray-200">
        ...
        <tbody>
          ...
          @empty
            <tr><td colspan="7" class="px-3 py-6 text-center text-gray-500">Sin datos todavía</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
